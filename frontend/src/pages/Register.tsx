...
import { Loader2, Sparkles, Check, X, Github } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="px-6 pb-6 pt-0">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button variant="outline" type="button" onClick={() => window.location.href = 'http://localhost:5000/api/auth/github'}>
